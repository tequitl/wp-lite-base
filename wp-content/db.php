...
$sqlite_plugin_implementation_folder_path = 'C:\xampp\htdocs\wp-lite-base\wp-content\plugins\sqlite-database-integration';
...
add_action(
	...
	function() {
		...
		if ( is_plugin_inactive( 'C:\xampp\htdocs\wp-lite-base\wp-content\plugins\sqlite-database-integration\load.php' ) ) {
			...
			if ( null !== activate_plugin( 'C:\xampp\htdocs\wp-lite-base\wp-content\plugins\sqlite-database-integration\load.php', '', false, true ) ) {
